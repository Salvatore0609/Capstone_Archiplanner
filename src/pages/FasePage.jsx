      ...
      <Row>
        ...
        <Col sm={11} className="main-dashboard">
          ...
          <div className="carousel-arrow">
            {activeIndex > 0 && (
              <button onClick={handlePrev} className="carousel-control" aria-label="Previous">
                <FaChevronLeft size={30} color="#C69B7B" />
              </button>
            )}
            {activeIndex < totalSlides - 1 && (
              <button onClick={handleNext} className="carousel-control" aria-label="Next">
